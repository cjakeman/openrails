...
namespace Orts.Viewer3D
{
    public class Viewer
    {
        ...
        void HandleUserInput(ElapsedTime elapsedTime)
        {
            ...
            if (UserInput.IsPressed(UserCommand.DisplayNextStationWindow)) 
                ...
                else
                {
                    ...
                    if (NextStationWindow.Visible && NextStationWindow.SpeechRequired == false)
                        NextStationWindow.SpeechRequired = true;
                    else
                        if (NextStationWindow.Visible == false && NextStationWindow.SpeechRequired == true)
                            NextStationWindow.SpeechRequired = false;
                }
