...
namespace Orts.Viewer3D.RollingStock
{
    public class MSTSWagonViewer : TrainCarViewer
    {
        ...
        private Quaternion GetAdjacentCarQuaternion(TrainCar adjacentCar)
        {
            ...
            {
                pAdjacent.XNAMatrix.M11 *= -1;
                pAdjacent.XNAMatrix.M13 *= -1;
                pAdjacent.XNAMatrix.M31 *= -1;
                pAdjacent.XNAMatrix.M33 *= -1;
            }

            // Get the orientation of the car as a quaternion
            pAdjacent.XNAMatrix.Decompose(out Vector3 scaleAdjacent, out Quaternion quaternionAdjacent, out Vector3 translationAdjacent);
